...
export const PLAYERS: Player[] = [
  { id: '1', name: 'Leo Martins', country: 'BR', pos: 'Striker', age: 19, foot: 'Right', photo: PIC(32), photos: GAL(32, 11), yt: YT[0], pro: true, verified: true, match: 96, headline: '41 goals · 18 assists', stats: { Appearances: 60, Goals: 41, Assists: 18, 'Pass %': 82 }, career: [['2014–2018', 'Santos Youth Academy'], ['2018–2021', 'Santos U-17'], ['2021–now', 'Santos B Team']] },
  { id: '2', name: 'Diego Santos', country: 'AR', pos: 'Left Winger', age: 18, foot: 'Left', photo: PIC(45), photos: GAL(45, 21), yt: YT[1], pro: true, verified: true, match: 91, headline: '28 goals · 22 assists', stats: { Appearances: 44, Goals: 28, Assists: 22, 'Pass %': 79 }, career: [['2016–2020', 'River Plate Academy'], ['2020–now', 'River Plate U-19']] },
  ...
  { id: '4', name: 'Lucas Müller', country: 'DE', pos: 'Centre-Back', age: 21, foot: 'Right', photo: PIC(51), photos: GAL(51, 41), yt: YT[3], pro: true, verified: true, match: 84, headline: '140 tackles · 91% pass', stats: { Appearances: 52, Tackles: 140, 'Aerial %': 74, 'Pass %': 91 }, career: [['2015–2019', 'Bayern Youth'], ['2019–now', 'TSV 1860 U-21']] },
